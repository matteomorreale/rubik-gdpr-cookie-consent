 ...
 * Orchestrates the hooks of the plugin.
 *
 * This class is responsible for registering all of the hooks that an individual plugin
 * can define. It registers the hooks with WordPress to ensure that it is executed and
 * properly called at the appropriate times in the execution of WordPress.
 *
 * @since      1.0.0
 * @package    Manus_GDPR
 * @subpackage Manus_GDPR/includes
